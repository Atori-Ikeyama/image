...
go test github.com/Atori-Ikeyama/image/font/sfnt -args -proprietary
...
go test github.com/Atori-Ikeyama/image/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
